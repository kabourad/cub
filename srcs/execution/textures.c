...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/20 16:51:34 by kabourad          #+#    #+#             */
/*   Updated: 2021/02/20 16:51:35 by kabourad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	check_assign(cub, 0, cub->parse.paths.west);
	check_assign(cub, 1, cub->parse.paths.north);
	check_assign(cub, 2, cub->parse.paths.east);
	check_assign(cub, 3, cub->parse.paths.south);
